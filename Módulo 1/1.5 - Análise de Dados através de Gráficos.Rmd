---
title: "1.5 - Análise de Dados através de Gráficos"
output: html_notebook
---

```{r}
# Remove objetos da memoria do R
...
```{r}
# visualiza a media (mean) e outras estatísticas descritivas das variáveis
summary(dados)

summary(dados$Preco_Cafe)  # estatisticas de uma so variavel
```
...
plot(y = dados$Vendas_Cafe,
     x = dados$Preco_Cafe,
  col = factor(dados$Promocao),  # cor baseada na coluna Promocao
  pch = 16,
  xlab = 'Preço',
  ylab = 'Quantidade Vendidade',
  main = 'Relação entre o Preço e as Vendas do Café')
...
boxplot(dados$Vendas_Cafe) #Gera boxplot das vendas
boxplot(dados$Preco_Cafe) #Gera boxplot do preco
boxplot(dados$Vendas_Cafe~dados$Promocao) #Gera boxplot comparativo das vendas quando houve promocao e de quando nao houve
